...
|
*/
$config['static_url'] = 'http://localhost/CodeIgniter/assets/';
...
| 所有使用附件地址的地方，请统一使用url辅助函数get_attachment_url，不要直接使用该配置项，也不要再写一遍路径
|
*/
$config['attachment_url'] = 'http://localhost/CodeIgniter/uploads/';
