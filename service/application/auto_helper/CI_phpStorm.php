 ...
 * @property MY_Image_lib $image_lib              Image Manipulation class
 ...
 * @property MY_Upload $upload                    File Uploading Class
 * @property CI_URI $uri                          Parses URIs and determines routing
 * @property MY_User_agent $agent				  Identifies the platform, browser, robot, or mobile devise of the browsing agent
 ...
 * @property Sms $sms                      		  短信发送类库
 */
class MY_Service extends my_models
{
